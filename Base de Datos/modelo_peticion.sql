...
CREATE TABLE `peticion` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_eecff370feb9565e1b0dced155a` (`peticionId`),
  CONSTRAINT `FK_eecff370feb9565e1b0dced155a` FOREIGN KEY (`peticionId`) REFERENCES `medicamento` (`id`)
...
INSERT INTO `peticion` VALUES (1,0,1),(2,0,1),(3,0,2),(4,0,2);
